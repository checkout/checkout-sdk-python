...
class WorkflowsClient(Client):
    ...
    def add_workflow_action(self, workflow_id: str, workflow_action_request: WorkflowActionRequest):
        return self._api_client.post(self.build_path(self.__WORKFLOWS_PATH, workflow_id, self.__ACTIONS_PATH),
                                     self._sdk_authorization(),
    ...
    def remove_workflow_action(self, workflow_id: str, action_id: str):
        return self._api_client.delete(
            self.build_path(self.__WORKFLOWS_PATH, workflow_id, self.__ACTIONS_PATH, action_id),
            self._sdk_authorization())

    def add_workflow_condition(self, workflow_id: str, workflow_condition_request: WorkflowConditionRequest):
        return self._api_client.post(
            self.build_path(self.__WORKFLOWS_PATH, workflow_id, self.__CONDITIONS_PATH),
            self._sdk_authorization(),
    ...
    def remove_workflow_condition(self, workflow_id: str, condition_id: str):
        return self._api_client.delete(
            self.build_path(self.__WORKFLOWS_PATH, workflow_id, self.__CONDITIONS_PATH, condition_id),
            self._sdk_authorization())
