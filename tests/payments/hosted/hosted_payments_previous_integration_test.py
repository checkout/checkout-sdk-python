...
def test_should_create_and_get_hosted_payments_page_details(previous_api):
    ...
    response = previous_api.hosted_payments.create_hosted_payments_page_session(request)
    ...
    hosted_details = previous_api.hosted_payments.get_hosted_payments_page_details(response.id)
