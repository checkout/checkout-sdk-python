...
def test_should_query_disputes(four_api):
...
def test_should_upload_file(four_api):
    request = FileRequest()
...
def test_should_test_full_disputes_workflow(four_api):
    ...
    upload_file_response = four_api.disputes.upload_file(request)
