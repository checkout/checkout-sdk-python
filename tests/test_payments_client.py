...
from checkout_sdk import HttpClient, Config, Utils, HttpMethod
from tests.base import CheckoutSdkTestCase
from enum import Enum

from checkout_sdk.payments import PaymentsClient, PaymentResponse, PaymentPending, PaymentProcessed
...
class PaymentsClientTests(CheckoutSdkTestCase):
    ...
    def assert_payment_response(self, payment, clazz=PaymentResponse, is_pending=False):
